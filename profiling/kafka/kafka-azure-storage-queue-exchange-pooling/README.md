# Kafka to Azure Storage Queue with Exchange Pooling

In the routes.yaml and camel-jbang-route.yaml files, set correctly the Azure credentials for storage queue.
...
docker run --rm -ti \
    ...
    --network="host" \
    quay.io/oscerd/kafka-azure-storage-queue-exchange-pooling:1.0-SNAPSHOT-jvm
```
